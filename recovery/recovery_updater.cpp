...
void Register_librecovery_updater_exynos7904() {
    RegisterFunction("exynos7904.verify_no_downgrade", VerifyNoDowngradeFn);
    RegisterFunction("exynos7904.mark_header_bt", MarkHeaderBtFn);
    RegisterFunction("exynos7904.write_data_bt", WriteDataBtFn);
}
